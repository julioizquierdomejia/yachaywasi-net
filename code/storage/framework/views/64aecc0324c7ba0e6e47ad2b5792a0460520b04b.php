		        ...
		        <form class="form-group" method="POST" action="/course" enctype="multipart/form-data">
		            ...
		            <div class="col-md-8 pr-1">
		              <div class="form-group">
		                <label>nombre de Área</label>
							<input type="text" name="name" placeholder="Nombre del Curso" class="form-control mb-2" value="<?php echo e($curso->name); ?>">
		              </div>
		            </div>
		          ...
		          <div class="row">
		            <div class="update ml-auto mr-auto">
		              ...
		              <a href="<?php echo e(route('course.index')); ?>" class="btn btn-success" style="font-size: 14px;"><i class="fas fa-arrow-circle-left mr-2" style="font-size: 18px;"></i> Voler a ver cursos</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/admin/course/edit.blade.php ENDPATH**/ ?>