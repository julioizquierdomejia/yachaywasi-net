              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    ...
                    <?php endif; ?>
                    <h5 class="title"><?php echo e($userAuth->name); ?></h5>
                  </a>
                  <p class="description">
                    Colegio Vigotsky
                  </p>
	                  ...
	                  <li>
	                    <div class="row">
	                      ...
	                      <div class="col-md-7 col-7">
	                        <?php echo e($docente->name); ?>

	                        <br />
	                        <span class="text-muted"><small>Miss 4 añitos</small></span>
	                      </div>
	                      <div class="col-md-3 col-3 text-right">
	                      	<a href="<?php echo e(route('user.show', $docente->id )); ?>" class="btn btn-sm btn-outline-info btn-round btn-icon">
	                      		<i class="far fa-edit"></i>
	                      	</a>
	                        <form class="form-group d-inline" method="POST" action="/user/<?php echo e($docente->id); ?>">
						      	<?php echo csrf_field(); ?>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="submit" class="btn btn-sm btn-outline-danger btn-round btn-icon"><i class="far fa-trash-alt"></i></button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/julio/Desktop/dev/yachaywasinet/resources/views/admin/users/index.blade.php ENDPATH**/ ?>