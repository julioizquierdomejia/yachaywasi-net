...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Registrar Colegio')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="school" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nombre del Colegio')); ?></label>

                            <div class="col-md-6">
                                <input id="school" type="text" class="form-control <?php $__errorArgs = ['school'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="school" value="<?php echo e(old('school')); ?>" required autocomplete="school" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="slug" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nombre corto')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="slug" value="<?php echo e(old('slug')); ?>" required autocomplete="slug" autofocus>

                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Telefono')); ?></label>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/resources/views/auth/register.blade.php ENDPATH**/ ?>