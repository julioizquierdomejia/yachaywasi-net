<?php $__env->startSection('content'); ?>
	...
	<!--
	<?php echo Form::open(['url' => 'user/store', 'method' => 'POST', 'files' => true]); ?>

		<div class="form-group">
			<?php echo Form::label('name', 'Nombre'); ?>

			<?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de usuario']); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el Correo electrónico']); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::text('password', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el Pasword']); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::text('slug', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el slug']); ?>

		</div>

		<div class="form-group">
			<?php echo Form::label('avatar', 'Foto de Perfil'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/julio/Desktop/dev/yachaywasinet/resources/views/admin/users/create.blade.php ENDPATH**/ ?>