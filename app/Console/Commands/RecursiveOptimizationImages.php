...
class RecursiveOptimizationImages extends Command
{
            ...
            if($fileInfo->isDot()) {
                ...
                if (is_dir($file_path)) {
                    ...
                    if (in_array($fileInfo->getExtension(), $extensions)) {
                        ...
                        $this->intervention_image(dirname($file_path), $fileInfo->getFilename(), null, null, true, true);
                    }
                }
            }
        }
    ...
    protected function intervention_image($path, $fileName, $width, $height, $compress = false, $override = false)
    {
        $response = '';
        $time = time();
